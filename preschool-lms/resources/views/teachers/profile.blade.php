<x-app-layout>
    ...
    <div class="py-12 flex justify-center w-full bg-gray-100"> 
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 text-center 
            ...
            <div class="mb-4">
                <img src="https://ui-avatars.com/api/?name={{ urlencode($teacher->first_name.' '.$teacher->surname) }}&size=128"
                     alt="Profile Image"
            ...
            <p class="text-gray-500 dark:text-gray-300 text-sm">{{ $teacher->designation }}</p>
            
            <div class="mt-4 text-gray-700 dark:text-gray-200">
            <div class="flex flex-col sm:flex-row justify-between border-b py-2">
                <span class="font-semibold">Email:</span>
                <span class="sm:text-right">{{ $teacher->email }}</span>
            </div>
            <div class="flex flex-col sm:flex-row justify-between border-b py-2">
                <span class="font-semibold">Contact:</span>
                <span class="sm:text-right">{{ $teacher->contact_number }}</span>
            </div>
            <div class="flex flex-col sm:flex-row justify-between py-2">
                <span class="font-semibold">Gender:</span>
                <span class="sm:text-right">{{ ucfirst($teacher->sex) }}</span>
            </div>
        </div>
