...
<x-app-layout>
    ...
    <form action="{{ route('enrollment.store') }}" method="POST" class="form-container w-full  mx-auto p-12 bg-white shadow-lg rounded-lg" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('enrollment.downloadBlankForm') }}" 
       class="bg-green-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-green-600 mt-4">
        Download Form
    </a>
</div>
