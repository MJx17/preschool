<section id="about" class="bg-white">
    <div class="max-w-6xl mx-auto px-6 space-y-20">
        ...
        <!-- About (full-width bg) -->
        <div class="w-screen bg-gray-200 py-16 md:py-24 relative left-1/2 right-1/2 -mx-[50vw]">
        ...
        <!-- Vision (full-width bg) -->
        <div class="w-screen bg-gray-200 py-16 md:py-24 relative left-1/2 right-1/2 -mx-[50vw]">
            <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
                <img src="{{ asset('/vision.png') }}" alt="Vision"
                    class="w-full rounded-lg shadow-md md:order-2" />
        ...
        <!-- Core Values -->
        <div class="py-16 md:py-24 flex flex-col items-center text-center px-6">
            <h2 class="text-3xl font-bold mb-12">Our Core Values</h2>

            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">
                <div class="p-6 bg-gray-50 rounded-lg shadow hover:shadow-lg transition text-center">
        ...
        <div class="w-screen bg-gray-200 py-16 md:py-24 relative left-1/2 right-1/2 -mx-[50vw]">
            <div class="max-w-6xl mx-auto px-6">
                <div class="flex flex-col items-center text-center">
                    <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center">
